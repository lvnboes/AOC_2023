...
ways_to_win_multiplied(TimesAndDists) -> 
    multiply_all([calculate_ways_to_win(TimeAndDist) || TimeAndDist <- TimesAndDists]).
...
solve() ->
    ...
    #{
        part1 => ways_to_win_multiplied(parse_for_part_1(Input)),
        part2 => calculate_ways_to_win(parse_for_part_2(Input))
    }.
